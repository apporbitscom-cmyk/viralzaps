...
(function () {
    ...
    function showTrendingTopicsView(container) {
        ...
        var apiBaseUrl = (typeof window !== 'undefined' && window.VIRALZAPS_PUBLIC_CONFIG && window.VIRALZAPS_PUBLIC_CONFIG.apiBaseUrl)
            ...
            : (typeof window !== 'undefined' && window.RAZORPAY_CONFIG && window.RAZORPAY_CONFIG.apiBaseUrl)
                ? window.RAZORPAY_CONFIG.apiBaseUrl
                : (typeof window !== 'undefined' && window.VIRALZAPS_LOCAL_API_BASE_URL) || '';
